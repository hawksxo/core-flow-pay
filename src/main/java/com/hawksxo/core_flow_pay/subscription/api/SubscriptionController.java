...
public class SubscriptionController {
    ...
    public ResponseEntity<SubscriptionResponse> create(
        ...
        CreateSubscriptionCommand command = new CreateSubscriptionCommand(request.userId(), idempotencyKey);
    ...
    public record CreateSubscriptionRequest(@NotBlank String userId) {}
}